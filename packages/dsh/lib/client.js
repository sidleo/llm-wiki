...
`;
		...
		function Card() {
			...
			}, e("span", { className: "dwHeadText" }, e("span", { className: "dwName" }, "llm-wiki 知识库"), e("span", { className: "dwDesc" }, state ? `默认：${state.active.name}（${state.active.path}）` : "正在读取…")), e(Chevron, { open: true })), e("div", { className: "dwBody" }, err ? e("div", { className: "dwWarn" }, `✕ ${err}`) : null, notice ? e("div", { className: "dwOk" }, `✓ ${notice}`) : null, e(Section, {
				title: "命名目录（bundle）",
